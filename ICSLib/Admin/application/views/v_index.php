	...
	<div class="container">
		...
		<div class="tabbable" id="tabs-931288">
				<ul class="nav nav-pills">
					...
					<li>
						<a href="#panel-5" data-toggle="tab">Send Mail</a>
					</li>
				</ul>
				<div class="tab-content">
					...
					<div class="tab-pane" id="panel-5">
						<p>
							...
							$mail="welcome";
								if($mail!=""){
									$to = "edmarenpadua@gmail.com";
									$subject = "Test mail";
									$from = "librarian@gmail.com";
									$headers = "From:" . $from;
									if ($mail == 'welcome')
											$message = "Welcome! Thank you for registering an account.";
									else if($mail == 'overdue')
											$message = "You have an overdue book. Please visit your ICSLib Account for more details.";
									else if($mail == 'acquired')
											$message = "No need to waitlist. Book is acquired.";
									else if($mail == 'pickup')
									...
									if (mail($to,$subject,$message,$headers)){
										...
										echo "Error in sending mail. Please check server.";
								}
